...
interface ImportMetaEnv {
  ...
  // Версия сборки. Нужна для регрессий, suspect commits и release health.
  // На сопоставление бандла с source map НЕ влияет: этим занимаются Debug ID,
  // которые вшивает @sentry/vite-plugin.
